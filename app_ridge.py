...
from predict_race_2 import predict_race, RESULTS_PATH

st.set_page_config(page_title="F1 Race Predictor", layout="wide")
st.title("🏎️ F1 Finishing Order Predictor")
st.caption("Grid position blended with a Ridge regression model, validated via walk-forward testing across 2022-2026.")
